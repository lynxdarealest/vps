...
public class TopEventOtherWeekly extends TopWeekly {

    public TopEventOtherWeekly() {
        super(TopType.TOP_EVENT_OTHER_WEEKLY, "Sự kiện");
    }
    ...
    public void init() {
        ...
        try {
            ...
            List<PointWeeklyData> objects = GameRepository.getInstance().pointWeekly.findTopEventOther(Server.ID, startOfWeek, limit);
            for (PointWeeklyData object : objects) {
                TopEventOtherWeeklyInfo top = new TopEventOtherWeeklyInfo(null);
    ...
    public void setObject(Object object) {
        ...
        try {
            ...
            elements.add(new TopEventOtherWeeklyInfo(player));
        } finally {
            lock.writeLock().unlock();
        }
    }
