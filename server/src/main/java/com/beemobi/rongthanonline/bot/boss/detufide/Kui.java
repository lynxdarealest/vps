...
public class Kui extends Boss {
    private static final Logger logger = Logger.getLogger(Kui.class);
    private static final int[] MAPS = {MapName.DOI_MORI, MapName.NUI_MORI, MapName.SUON_NUI_MORI};

    public Kui() {
        super(BossName.KUI, -1);
        typePk = 3;
    }
