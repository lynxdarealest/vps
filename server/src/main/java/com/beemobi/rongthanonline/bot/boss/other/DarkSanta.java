...
public class DarkSanta extends Boss {
    private static final Logger logger = Logger.getLogger(DarkSanta.class);
    ...
    public long formatDamageInjure(Entity attacker, long damage, boolean isCritical) {
        return Math.max(Math.min(hp / 100, damage), 1);
    }
