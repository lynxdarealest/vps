...
public class WhiteIII extends Boss {
    private static final Logger logger = Logger.getLogger(WhiteIII.class);

    public WhiteIII(int level) {
        super(BossName.WHITE_III, -1);
        typePk = 3;
        this.level = level;
