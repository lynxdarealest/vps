...
public class PocSummer extends Boss {
    private static final Logger logger = Logger.getLogger(PocSummer.class);

    private static final int[] MAPS = {MapName.DAO_HOA_2};

    public PocSummer() {
        super(BossName.POC_SUMMER, -1);
        typePk = 3;
