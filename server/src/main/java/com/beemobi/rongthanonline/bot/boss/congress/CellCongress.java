package com.beemobi.rongthanonline.bot.boss.congress;
...
public class CellCongress extends Boss {
    private static final Logger logger = Logger.getLogger(CellCongress.class);
