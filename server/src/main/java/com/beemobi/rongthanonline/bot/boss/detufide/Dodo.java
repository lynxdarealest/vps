...
public class Dodo extends Boss {
    private static final Logger logger = Logger.getLogger(Dodo.class);
    private static final int[] MAPS = {MapName.THUNG_LUNG_MORI, MapName.LANG_MORI, MapName.VACH_NUI_MORI};

    public Dodo() {
        super(BossName.DODO, -1);
        typePk = 3;
    }
